<div id="maincolumn">
	...
	<h2 class="main" style="background:url(<?= base_url() ?>modules/Rss/assets/images/icon_48_module.png) no-repeat top left;"><?= config_item('module_rss_name') ?></h2>
	...
	<div class="subtitle">
		...
		<p><a href="<?= base_url().$uri ?>" target="_blank"><?= base_url().$uri ?></a><br/>
		
		<?php foreach (Settings::get_languages() as $lang) :?>
		
			<a href="<?= base_url().$uri .'/feed/'. $lang['lang'] ?>" target="_blank"><?= base_url().$uri .'/feed/'. $lang['lang'] ?></a><br/>
	...
	<div id="rssTab" class="mainTabs">
		...
		<ul class="tab-menu">
			...
			<li id="rssConfigTab"><a><?= lang('module_rss_settings') ?></a></li>
			<li  id="rssPagesTab"><a><?= lang('module_rss_pages') ?></a></li>
	...
	<div id="rssTabContent">
		...
		<div class="tabcontent">
			...
			<form id="rssSettingsForm" name="rssSettingsForm" method="post">
				...
				<!-- RSS feed title -->
				<dl>
					<dt><label for="module_rss_feed_title"><?= lang('module_rss_label_feed_title') ?></label></dt>
					<dd>
						<input class="inputtext w240" type="text" name="module_rss_feed_title" id="module_rss_feed_title" value="<?= config_item('module_rss_feed_title') ?>" />
					</dd>
				</dl>	
		
				<!-- RSS feed description -->
				<dl>
					<dt><label for="module_rss_feed_description"><?= lang('module_rss_label_feed_description') ?></label></dt>
					<dd>
						<input class="inputtext w240" type="text" name="module_rss_feed_description" id="module_rss_feed_description" value="<?= config_item('module_rss_feed_description') ?>" />
					</dd>
				</dl>	
		
				<!-- RSS feed author (email, optional) -->
				<dl>
					<dt><label for="module_rss_feed_author"><?= lang('module_rss_label_feed_author') ?></label></dt>
					<dd>
						<input class="inputtext w240" type="text" name="module_rss_feed_author" id="module_rss_feed_author" value="<?= config_item('module_rss_feed_author') ?>" />
					</dd>
				</dl>	
