...
class Setting extends MY_admin 
{
	...
	function save_ionize()
	{
		...
		if ( false == $this->_update_language_config_file($default_admin_lang))
	 ...
	 *
	 */
	function _update_language_config_file($default_admin_lang)
	{
		// Files begin
		...
		$conf .= "\$config['default_admin_lang'] = '".$default_admin_lang."';\n\n";
		...
		$conf .= "\$config['default_lang_code'] = '".config_item('default_lang_code')."';\n\n";
		...
		$conf .= "\$config['detected_lang_code'] = '".config_item('detected_lang_code')."';\n\n";

		$conf .= "// Available languages\n";
		$conf .= "// Languages set through Ionize. Includes offline languages\n";
		$conf .= "\$config['available_languages'] = ".dump_variable(config_item('available_languages'))."\n\n";

		$conf .= "// Online languages\n";
		$conf .= "// Languages set online through Ionize.\n";
		$conf .= "\$config['online_languages'] = ".dump_variable(config_item('online_languages'))."\n\n";

		// files end
		$conf .= "\n\n";
		$conf .= '/* End of file language.php */'."\n";
		$conf .= '/* Auto generated by Ionize Interface Administration on : '.date('Y.m.d H:i:s').' */'."\n";
