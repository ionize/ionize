...
INSERT INTO `article_lang` (`id_article`, `lang`, `url`, `title`, `subtitle`, `meta_title`, `summary`, `content`, `meta_keywords`, `meta_description`, `online`) VALUES(8, 'en', 'follow-us', 'Follow us', '', '', NULL, '<p><a href="/rss/"><img src="/ionize-with_ci2/files/website/icon-round-rss.png" /></a> <img src="/ionize-with_ci2/files/website/icon-round-twitter.png" height="36" width="36" /> <img src="/ionize-with_ci2/files/website/icon-round-ionize.png" /> <img src="/ionize-with_ci2/files/website/icon-round-email.png" /> <br /> (The RSS icon links to the RSS module)</p>', NULL, NULL, 1);
