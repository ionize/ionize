...
VALUES
	...
	(101,100,'admin/tree/menu','add_page,edit','',''),
	(102,100,'admin/tree/page','status,add_page,add_article,order','',''),
	(103,100,'admin/tree/article','unlink,status,move,copy,order','',''),
