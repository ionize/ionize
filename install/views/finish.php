...
<script type="text/javascript">
	function deleteInstallFolder() {
		document.location.href = '?step=deleteinstaller&lang=<?php echo $lang ?>';
	}
</script>
...
<div class="block content">
	...
	<div class="buttons">
		...
		<button type="button" class="button info left" onclick="javascript:document.location.href='?step=deleteinstaller&goto=admin'"><?php echo lang('button_go_to_admin') ?></button>
	</div>
</div>
