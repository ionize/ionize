...
*/
	...
	function _save_database_settings_to_file($data)
	{
		...
		$conf  = "<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');\n\n"
			...
			. "\$db['default']['hostname'] = '{$data['db_hostname']}';\n"
			. "\$db['default']['username'] = '{$data['db_username']}';\n"
			. "\$db['default']['password'] = '{$_POST['db_password']}';\n"
			. "\$db['default']['database'] = '{$data['db_name']}';\n"
			. "\$db['default']['dbdriver'] = '{$data['db_driver']}';\n"
			. "\$db['default']['dbprefix'] = '';\n"
			. "\$db['default']['swap_pre'] = '';\n"
	...
	function _save_language_config_file($data)
	{
		...
		// Language file save
		$varDumpAvailLanguages = dump_variable($available_languages);
		$conf  = "<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');\n\n"
			...
			.  "\$config['default_lang_code'] = '$def_lang';\n\n"
			...
			.  "\$config['detected_lang_code'] = '$def_lang';\n\n"

			.  "// Available languages\n"
			.  "// Languages set through Ionize. Includes offline languages\n"
			.  "\$config['available_languages'] = $varDumpAvailLanguages\n\n"

			.  "// Online languages\n"
			.  "// Languages set online through Ionize.\n"
			.  "\$config['online_languages'] = $varDumpAvailLanguages\n\n"

			.  "// Default Translations Language Code\n"
			.  "// Used as reference by the translation tool\n"
			.  "\$config['default_translation_lang_code'] = '$def_lang';\n\n"

		// files end
			. "\n\n"
			. '/* End of file language.php */'."\n"
			. '/* Auto generated by Ionize Installer on : '.date('Y.m.d H:i:s').' */'."\n"
