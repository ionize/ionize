...
<link rel="stylesheet" href="<?= theme_url() ?>css/installer.css" type="text/css" />
...
<div id="page">
	...
	<div id="content">
		...
		<img src="<?= theme_url() ?>images/ionize_logo_install.jpg" />
		...
		<button type="button" class="button yes right" onclick="javascript:location.href='<?= admin_url() ?>';"><?= lang('button_delete_installer_done_admin') ?></button>
