<div id="maincolumn">
    <h2 class="main articles"><?php echo $filename; ?></h2>
    <div class="subtitle">
        <form>
            <div class="w400 relative">
                <label class="left"><?php echo lang('ionize_label_article_filter'); ?></label>
                <input id="search_translation" type="text" class="inputtext w300 left" />
    ...
    <hr />
    <div class="h20">
        <a class="button light" id="backToTranslationsButton">
            <i class="icon-back"></i><?php echo lang('ionize_label_back_to_translations'); ?>
        </a>
                                                ...
                                                <?php
                                                    echo form_textarea(
                                                        array(
                                                            ...
                                                            'value' => ''.$value.'',
                                                            'rows' => $textarea_rows,
                                                            'class' => 'translation_term_value textarea'
                                                        )
                                                    );
                                                ?>
                                                ...
                                                <?php
                                                    echo form_input(
                                                        array(
                                                            ...
                                                            'id' => $lang . '_' . $el_id,
                                                            'value' => ''.$value.'',
                                                            'class' => 'translation_term_value inputtext',
                                                        )
                                                    );
                                                ?>
...
<script type="text/javascript">
    ...
    $('backToTranslationsButton').addEvent('click', function(){
        ION.HTML(
