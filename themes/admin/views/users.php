...
<div id="maincolumn">
	...
	<div class="tab">
		<ul id="tabs" class="tab-content">
			<li id="tab-users" rel="users" item="data"><a><span><?= lang('ionize_title_existing_users') ?></span></a></li>
			<li id="tab-groups" rel="groups" item="data"><a><span><?= lang('ionize_title_existing_groups') ?></span></a></li>
			<li id="tab-export" rel="export" item="data"><a><span><?= lang('ionize_title_users_export') ?></span></a></li>
		</ul>
	</div>

	<!-- Existing users table -->
	<div id="block-users" class="block data">
	...
	<div id="block-groups" class="block data">
	...
	<!-- Export tool -->
	<div id="block-export" class="block data">
...
<script type="text/javascript">
	...
	// Users list tab
	$('tab-users').removeEvents().addEvent('click', function(){ 
		ION.displayBlock('.data', 'users'); 
