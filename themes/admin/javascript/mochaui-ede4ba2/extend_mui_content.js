...
var initializeContent = function()
{
	 ...
	 *	
	 */
	ION.initToolbox = function(toolbox_url, onContentLoaded)
	{
...
*/
	 ...
	 *	
	 */
	ION.initAccordion = function(togglers, elements, openAtStart) 
	{
		...
		var disp = (typeOf(openAtStart) != false) ? 0 : -1;
	...
	{
		Array.each(elements, function(options, key)
		{
