 ...
 *
 */
if( ! function_exists('get_custom_tree_navigation'))
{
	function get_custom_tree_navigation($items, $id = NULL, $class = NULL, $first_class = NULL, $last_class = NULL)
	{
		// HTML Attributes
		$id = ( ! is_null($id) ) ? ' id="' . $id . '" ' : '';
		...
		foreach($items as $key => $page)
		{
			if ($key !== 'articles')
			{
				...
				if (!empty($page['children']))
					 $tree .= get_custom_tree_navigation($page['children']);
