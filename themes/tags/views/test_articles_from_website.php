...
<pre>
&lt;ion:articles all="true" filter="menu.name='main' and indexed=1" order-by="date DESC" limit="3">
    &lt;ion:article>
        &lt;ion:title tag="h3" />
...
<h3>Result</h3>
<ion:articles all="true" filter="menu.name='main' and indexed=1" order_by="date DESC" limit="3">
	<ion:article>
		<ion:title tag="h3" />
		<ion:content paragraph="1" />
	</ion:article>
